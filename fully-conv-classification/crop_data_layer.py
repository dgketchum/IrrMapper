...
class CropDataLayer(object):
    ...
    def __init__(self, target_profile=None, year=None, out_dir=None, from_file=None):
        ...
        self.url_base = 'https://nassgeodata.gmu.edu/axis2/services/CDLService/GetCDLFile?year={year}&bbox={wsen}'
        ...
        if from_file:
            ...
            if target_profile and year:
                ...
                self.bbox_projected = bb = self.bbox.to_epsg(5070)

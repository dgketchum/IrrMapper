                ...
                for j in range(0, master.shape[2], CHUNK_SIZE):
                    ...
                    if sub_master.shape[1] == CHUNK_SIZE and sub_master.shape[2] == CHUNK_SIZE:
                        for msk in masks:
                            ...
                            s = s[:, 92:-92, 92:-92] # clip edges for unet.
...
if __name__ == '__main__':
    ...
    train_dir = 'training_data/multiclass/train_3927/'
    shp_train = 'shapefile_data/train_3927/'
    count = 0
    save = True
